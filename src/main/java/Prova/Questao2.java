...
public class Questao2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(i1.exibir()); // 2a 
        System.out.println(i2.exibir()); // 2b
        System.out.println(i3.exibir()); // 2c
        System.out.println(i4.exibir()); // 2d
        ...
        System.out.println(bandaMaior); // 2e
        ...
        System.out.println(bandaMaior); // 2f
    }
}